...
public final class GetBucketCorsRequest extends S3Request implements
        ToCopyableBuilder<GetBucketCorsRequest.Builder, GetBucketCorsRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(GetBucketCorsRequest::bucket))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(GetBucketCorsRequest::expectedBucketOwner))
     ...
     * </p>
     * 
     * @return The bucket name for which to get the cors configuration.
     */
    ...
    public final String toString() {
        return ToString.builder("GetBucketCorsRequest").add("Bucket", bucket()).add("ExpectedBucketOwner", expectedBucketOwner())
                .build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<GetBucketCorsRequest, T> g) {
        return obj -> g.apply((GetBucketCorsRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, GetBucketCorsRequest> {
        /**
         * <p>
         * The bucket name for which to get the cors configuration.
         * </p>
