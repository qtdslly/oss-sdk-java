...
public final class DeleteBucketTaggingRequest extends S3Request implements
        ToCopyableBuilder<DeleteBucketTaggingRequest.Builder, DeleteBucketTaggingRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(DeleteBucketTaggingRequest::bucket))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(DeleteBucketTaggingRequest::expectedBucketOwner))
     ...
     * </p>
     * 
     * @return The bucket that has the tag set to be removed.
     */
    ...
    public final String toString() {
        return ToString.builder("DeleteBucketTaggingRequest").add("Bucket", bucket())
    ...
    private static <T> Function<Object, T> getter(Function<DeleteBucketTaggingRequest, T> g) {
        return obj -> g.apply((DeleteBucketTaggingRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, DeleteBucketTaggingRequest> {
        /**
         * <p>
         * The bucket that has the tag set to be removed.
         * </p>
