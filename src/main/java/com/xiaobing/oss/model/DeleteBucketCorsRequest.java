...
public final class DeleteBucketCorsRequest extends S3Request implements
        ToCopyableBuilder<DeleteBucketCorsRequest.Builder, DeleteBucketCorsRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(DeleteBucketCorsRequest::bucket))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(DeleteBucketCorsRequest::expectedBucketOwner))
     ...
     * </p>
     * 
     * @return Specifies the bucket whose <code>cors</code> configuration is being deleted.
     */
    ...
    public final String toString() {
        return ToString.builder("DeleteBucketCorsRequest").add("Bucket", bucket())
    ...
    private static <T> Function<Object, T> getter(Function<DeleteBucketCorsRequest, T> g) {
        return obj -> g.apply((DeleteBucketCorsRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, DeleteBucketCorsRequest> {
        /**
         * <p>
         * Specifies the bucket whose <code>cors</code> configuration is being deleted.
         * </p>
