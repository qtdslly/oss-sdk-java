...
public final class DeleteBucketLifecycleRequest extends S3Request implements
        ToCopyableBuilder<DeleteBucketLifecycleRequest.Builder, DeleteBucketLifecycleRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(DeleteBucketLifecycleRequest::bucket))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(DeleteBucketLifecycleRequest::expectedBucketOwner))
     ...
     * </p>
     * 
     * @return The bucket name of the lifecycle to delete.
     */
    ...
    public final String toString() {
        return ToString.builder("DeleteBucketLifecycleRequest").add("Bucket", bucket())
    ...
    private static <T> Function<Object, T> getter(Function<DeleteBucketLifecycleRequest, T> g) {
        return obj -> g.apply((DeleteBucketLifecycleRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, DeleteBucketLifecycleRequest> {
        /**
         * <p>
         * The bucket name of the lifecycle to delete.
         * </p>
