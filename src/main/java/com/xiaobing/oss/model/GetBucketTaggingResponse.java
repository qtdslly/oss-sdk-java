...
public final class GetBucketTaggingResponse extends S3Response implements
    ...
    private static final SdkField<List<Tag>> TAG_SET_FIELD = SdkField
            ...
            .memberName("TagSet")
            .getter(getter(GetBucketTaggingResponse::tagSet))
    ...
    private static <T> Function<Object, T> getter(Function<GetBucketTaggingResponse, T> g) {
        return obj -> g.apply((GetBucketTaggingResponse) obj);
    }
