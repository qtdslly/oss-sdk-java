...
public final class GetBucketLocationRequest extends S3Request implements
        ToCopyableBuilder<GetBucketLocationRequest.Builder, GetBucketLocationRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(GetBucketLocationRequest::bucket))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(GetBucketLocationRequest::expectedBucketOwner))
     ...
     * </p>
     * 
     * @return The name of the bucket for which to get the location.
     */
    ...
    public final String toString() {
        return ToString.builder("GetBucketLocationRequest").add("Bucket", bucket())
    ...
    private static <T> Function<Object, T> getter(Function<GetBucketLocationRequest, T> g) {
        return obj -> g.apply((GetBucketLocationRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, GetBucketLocationRequest> {
        /**
         * <p>
         * The name of the bucket for which to get the location.
         * </p>
