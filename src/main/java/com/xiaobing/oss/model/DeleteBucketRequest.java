...
public final class DeleteBucketRequest extends S3Request implements
        ToCopyableBuilder<DeleteBucketRequest.Builder, DeleteBucketRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(DeleteBucketRequest::bucket))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(DeleteBucketRequest::expectedBucketOwner))
     ...
     * </p>
     * 
     * @return Specifies the bucket being deleted.
     */
    ...
    public final String toString() {
        return ToString.builder("DeleteBucketRequest").add("Bucket", bucket()).add("ExpectedBucketOwner", expectedBucketOwner())
                .build();
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, DeleteBucketRequest> {
        /**
         * <p>
         * Specifies the bucket being deleted.
         * </p>
