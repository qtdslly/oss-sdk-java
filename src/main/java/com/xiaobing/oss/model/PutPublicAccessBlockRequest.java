...
public final class PutPublicAccessBlockRequest extends S3Request implements
        ToCopyableBuilder<PutPublicAccessBlockRequest.Builder, PutPublicAccessBlockRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(PutPublicAccessBlockRequest::bucket))
    ...
    private static final SdkField<String> CONTENT_MD5_FIELD = SdkField
            ...
            .getter(getter(PutPublicAccessBlockRequest::contentMD5))
    ...
    private static final SdkField<String> CHECKSUM_ALGORITHM_FIELD = SdkField
            ...
            .getter(getter(PutPublicAccessBlockRequest::checksumAlgorithmAsString))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(PutPublicAccessBlockRequest::expectedBucketOwner))
    ...
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(BUCKET_FIELD,
            CONTENT_MD5_FIELD, CHECKSUM_ALGORITHM_FIELD, PUBLIC_ACCESS_BLOCK_CONFIGURATION_FIELD, EXPECTED_BUCKET_OWNER_FIELD));
     ...
     * </p>
     * 
     * @return The name of the Amazon S3 bucket whose <code>PublicAccessBlock</code> configuration you want to set.
     */
     ...
     * </p>
     * 
     * @return The MD5 hash of the <code>PutPublicAccessBlock</code> request body. </p>
     *         <p>
    ...
    public final String toString() {
        return ToString.builder("PutPublicAccessBlockRequest").add("Bucket", bucket()).add("ContentMD5", contentMD5())
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, PutPublicAccessBlockRequest> {
        /**
         * <p>
         * The name of the Amazon S3 bucket whose <code>PublicAccessBlock</code> configuration you want to set.
         * </p>
         ...
         * 
         * @param contentMD5
         *        The MD5 hash of the <code>PutPublicAccessBlock</code> request body. </p>
         *        <p>
        ...
        /**
         * <p>
         * The <code>PublicAccessBlock</code> configuration that you want to apply to this Amazon S3 bucket. You can
         * enable the configuration options in any combination. For more information about when Amazon S3 considers a
         * bucket or object public, see <a href=
         * "https://docs.aws.amazon.com/AmazonS3/latest/dev/access-control-block-public-access.html#access-control-block-public-access-policy-status"
         * >The Meaning of "Public"</a> in the <i>Amazon S3 User Guide</i>.
         * </p>
         * 
         * @param publicAccessBlockConfiguration
         *        The <code>PublicAccessBlock</code> configuration that you want to apply to this Amazon S3 bucket. You
         *        can enable the configuration options in any combination. For more information about when Amazon S3
         *        considers a bucket or object public, see <a href=
         *        "https://docs.aws.amazon.com/AmazonS3/latest/dev/access-control-block-public-access.html#access-control-block-public-access-policy-status"
         *        >The Meaning of "Public"</a> in the <i>Amazon S3 User Guide</i>.
         * @return Returns a reference to this object so that method calls can be chained together.
         */
