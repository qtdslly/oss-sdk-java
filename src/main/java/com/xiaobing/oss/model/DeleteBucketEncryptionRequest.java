...
public final class DeleteBucketEncryptionRequest extends S3Request implements
        ToCopyableBuilder<DeleteBucketEncryptionRequest.Builder, DeleteBucketEncryptionRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(DeleteBucketEncryptionRequest::bucket))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(DeleteBucketEncryptionRequest::expectedBucketOwner))
     ...
     * </p>
     * 
     * @return The name of the bucket containing the server-side encryption configuration to delete.
     */
    ...
    public final String toString() {
        return ToString.builder("DeleteBucketEncryptionRequest").add("Bucket", bucket())
    ...
    private static <T> Function<Object, T> getter(Function<DeleteBucketEncryptionRequest, T> g) {
        return obj -> g.apply((DeleteBucketEncryptionRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, DeleteBucketEncryptionRequest> {
        /**
         * <p>
         * The name of the bucket containing the server-side encryption configuration to delete.
         * </p>
