...
public final class GetBucketLifecycleConfigurationRequest extends S3Request implements
        ToCopyableBuilder<GetBucketLifecycleConfigurationRequest.Builder, GetBucketLifecycleConfigurationRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(GetBucketLifecycleConfigurationRequest::bucket))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(GetBucketLifecycleConfigurationRequest::expectedBucketOwner))
     ...
     * </p>
     * 
     * @return The name of the bucket for which to get the lifecycle information.
     */
    ...
    public final String toString() {
        return ToString.builder("GetBucketLifecycleConfigurationRequest").add("Bucket", bucket())
    ...
    private static <T> Function<Object, T> getter(Function<GetBucketLifecycleConfigurationRequest, T> g) {
        return obj -> g.apply((GetBucketLifecycleConfigurationRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, GetBucketLifecycleConfigurationRequest> {
        /**
         * <p>
         * The name of the bucket for which to get the lifecycle information.
         * </p>
