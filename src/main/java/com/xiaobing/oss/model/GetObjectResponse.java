...
public final class GetObjectResponse extends S3Response implements
    ...
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(DELETE_MARKER_FIELD,
            ...
            CHECKSUM_CRC32_FIELD, CHECKSUM_CRC32_C_FIELD, CHECKSUM_SHA1_FIELD, CHECKSUM_SHA256_FIELD, MISSING_META_FIELD,
            VERSION_ID_FIELD, CACHE_CONTROL_FIELD, CONTENT_DISPOSITION_FIELD, CONTENT_ENCODING_FIELD, CONTENT_LANGUAGE_FIELD,
            CONTENT_RANGE_FIELD, CONTENT_TYPE_FIELD, EXPIRES_FIELD, WEBSITE_REDIRECT_LOCATION_FIELD,
            ...
            PARTS_COUNT_FIELD, TAG_COUNT_FIELD, OBJECT_LOCK_MODE_FIELD, OBJECT_LOCK_RETAIN_UNTIL_DATE_FIELD,
            OBJECT_LOCK_LEGAL_HOLD_STATUS_FIELD));
     ...
     * </p>
     * 
     * @return Provides information about object restoration action and expiration time of the restored object copy.
     */
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        return Objects.equals(deleteMarker(), other.deleteMarker()) && Objects.equals(acceptRanges(), other.acceptRanges())
                ...
                && Objects.equals(checksumSHA256(), other.checksumSHA256()) && Objects.equals(missingMeta(), other.missingMeta())
                && Objects.equals(versionId(), other.versionId()) && Objects.equals(cacheControl(), other.cacheControl())
    ...
    public final String toString() {
        return ToString.builder("GetObjectResponse").add("DeleteMarker", deleteMarker()).add("AcceptRanges", acceptRanges())
                ...
                .add("ChecksumSHA256", checksumSHA256()).add("MissingMeta", missingMeta()).add("VersionId", versionId())
