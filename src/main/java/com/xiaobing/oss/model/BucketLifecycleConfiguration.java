...
/**
 * <p>
 * Specifies the lifecycle configuration for objects in an Amazon S3 bucket. For more information, see <a
...
public final class BucketLifecycleConfiguration implements SdkPojo, Serializable,
        ToCopyableBuilder<BucketLifecycleConfiguration.Builder, BucketLifecycleConfiguration> {
    private static final SdkField<List<LifecycleRule>> RULES_FIELD = SdkField
            .<List<LifecycleRule>> builder(MarshallingType.LIST)
            .memberName("Rules")
            .getter(getter(BucketLifecycleConfiguration::rules))
    ...
    public final String toString() {
        return ToString.builder("BucketLifecycleConfiguration").add("Rules", hasRules() ? rules() : null).build();
    }
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, BucketLifecycleConfiguration> {
        /**
         * <p>
         * A lifecycle rule for individual objects in an Amazon S3 bucket.
         * </p>
