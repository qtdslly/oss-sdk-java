...
public final class IntelligentTieringAndOperator implements SdkPojo, Serializable,
        ToCopyableBuilder<IntelligentTieringAndOperator.Builder, IntelligentTieringAndOperator> {
    private static final SdkField<String> PREFIX_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Prefix")
            .getter(getter(IntelligentTieringAndOperator::prefix))
    ...
    private static final SdkField<List<Tag>> TAGS_FIELD = SdkField
            ...
            .memberName("Tags")
            .getter(getter(IntelligentTieringAndOperator::tags))
    ...
    public final String toString() {
        return ToString.builder("IntelligentTieringAndOperator").add("Prefix", prefix()).add("Tags", hasTags() ? tags() : null)
                .build();
    }
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, IntelligentTieringAndOperator> {
        /**
         * <p>
         * An object key name prefix that identifies the subset of objects to which the configuration applies.
         * </p>
