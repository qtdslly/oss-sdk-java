...
public final class GetObjectTorrentResponse extends S3Response implements
        ToCopyableBuilder<GetObjectTorrentResponse.Builder, GetObjectTorrentResponse> {
    private static final SdkField<String> REQUEST_CHARGED_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("RequestCharged")
            .getter(getter(GetObjectTorrentResponse::requestChargedAsString))
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        GetObjectTorrentResponse other = (GetObjectTorrentResponse) obj;
    ...
    public final String toString() {
        return ToString.builder("GetObjectTorrentResponse").add("RequestCharged", requestChargedAsString()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<GetObjectTorrentResponse, T> g) {
        return obj -> g.apply((GetObjectTorrentResponse) obj);
    }
    ...
    public interface Builder extends S3Response.Builder, SdkPojo, CopyableBuilder<Builder, GetObjectTorrentResponse> {
        /**
