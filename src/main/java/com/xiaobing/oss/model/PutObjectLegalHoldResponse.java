...
public final class PutObjectLegalHoldResponse extends S3Response implements
        ToCopyableBuilder<PutObjectLegalHoldResponse.Builder, PutObjectLegalHoldResponse> {
    private static final SdkField<String> REQUEST_CHARGED_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("RequestCharged")
            .getter(getter(PutObjectLegalHoldResponse::requestChargedAsString))
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        PutObjectLegalHoldResponse other = (PutObjectLegalHoldResponse) obj;
    ...
    private static <T> Function<Object, T> getter(Function<PutObjectLegalHoldResponse, T> g) {
        return obj -> g.apply((PutObjectLegalHoldResponse) obj);
    }
    ...
    public interface Builder extends S3Response.Builder, SdkPojo, CopyableBuilder<Builder, PutObjectLegalHoldResponse> {
        /**
