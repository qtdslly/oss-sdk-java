...
public final class NoSuchUploadException extends S3Exception implements
        ToCopyableBuilder<NoSuchUploadException.Builder, NoSuchUploadException> {
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, NoSuchUploadException>, S3Exception.Builder {
        @Override
