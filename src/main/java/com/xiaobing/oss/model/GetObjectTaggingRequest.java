...
public final class GetObjectTaggingRequest extends S3Request implements
        ToCopyableBuilder<GetObjectTaggingRequest.Builder, GetObjectTaggingRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(GetObjectTaggingRequest::bucket))
    ...
    private static final SdkField<String> KEY_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Key")
            .getter(getter(GetObjectTaggingRequest::key))
    ...
    private static final SdkField<String> VERSION_ID_FIELD = SdkField
            ...
            .getter(getter(GetObjectTaggingRequest::versionId))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(GetObjectTaggingRequest::expectedBucketOwner))
    ...
    private static final SdkField<String> REQUEST_PAYER_FIELD = SdkField
            ...
            .getter(getter(GetObjectTaggingRequest::requestPayerAsString))
    ...
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(BUCKET_FIELD, KEY_FIELD,
            VERSION_ID_FIELD, EXPECTED_BUCKET_OWNER_FIELD, REQUEST_PAYER_FIELD));
     ...
     * </p>
     * 
     * @return Object key for which to get the tagging information.
     */
     ...
     * </p>
     * 
     * @return The versionId of the object for which to get the tagging information.
     */
    ...
    public final String toString() {
        return ToString.builder("GetObjectTaggingRequest").add("Bucket", bucket()).add("Key", key())
                .add("VersionId", versionId()).add("ExpectedBucketOwner", expectedBucketOwner())
    ...
    private static <T> Function<Object, T> getter(Function<GetObjectTaggingRequest, T> g) {
        return obj -> g.apply((GetObjectTaggingRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, GetObjectTaggingRequest> {
        /**
         * <p>
         * The bucket name containing the object for which to get the tagging information.
         * </p>
