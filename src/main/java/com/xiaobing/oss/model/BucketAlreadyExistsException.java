...
public final class BucketAlreadyExistsException extends S3Exception implements
        ToCopyableBuilder<BucketAlreadyExistsException.Builder, BucketAlreadyExistsException> {
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, BucketAlreadyExistsException>, S3Exception.Builder {
        @Override
