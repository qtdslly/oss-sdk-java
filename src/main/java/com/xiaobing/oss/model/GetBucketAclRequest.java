...
public final class GetBucketAclRequest extends S3Request implements
        ToCopyableBuilder<GetBucketAclRequest.Builder, GetBucketAclRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(GetBucketAclRequest::bucket))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(GetBucketAclRequest::expectedBucketOwner))
     ...
     * </p>
     * 
     * @return Specifies the S3 bucket whose ACL is being requested.
     */
    ...
    public final String toString() {
        return ToString.builder("GetBucketAclRequest").add("Bucket", bucket()).add("ExpectedBucketOwner", expectedBucketOwner())
                .build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<GetBucketAclRequest, T> g) {
        return obj -> g.apply((GetBucketAclRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, GetBucketAclRequest> {
        /**
         * <p>
         * Specifies the S3 bucket whose ACL is being requested.
         * </p>
