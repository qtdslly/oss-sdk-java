...
public final class GetPublicAccessBlockRequest extends S3Request implements
        ToCopyableBuilder<GetPublicAccessBlockRequest.Builder, GetPublicAccessBlockRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(GetPublicAccessBlockRequest::bucket))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(GetPublicAccessBlockRequest::expectedBucketOwner))
     ...
     * </p>
     * 
     * @return The name of the Amazon S3 bucket whose <code>PublicAccessBlock</code> configuration you want to retrieve.
     */
    ...
    public final String toString() {
        return ToString.builder("GetPublicAccessBlockRequest").add("Bucket", bucket())
    ...
    private static <T> Function<Object, T> getter(Function<GetPublicAccessBlockRequest, T> g) {
        return obj -> g.apply((GetPublicAccessBlockRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, GetPublicAccessBlockRequest> {
        /**
         * <p>
         * The name of the Amazon S3 bucket whose <code>PublicAccessBlock</code> configuration you want to retrieve.
         * </p>
         * 
         * @param bucket
         *        The name of the Amazon S3 bucket whose <code>PublicAccessBlock</code> configuration you want to
         *        retrieve.
