...
public final class ExistingObjectReplication implements SdkPojo, Serializable,
        ToCopyableBuilder<ExistingObjectReplication.Builder, ExistingObjectReplication> {
    private static final SdkField<String> STATUS_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Status")
            .getter(getter(ExistingObjectReplication::statusAsString))
     ...
     * return {@link ExistingObjectReplicationStatus#UNKNOWN_TO_SDK_VERSION}. The raw value returned by the service is
    ...
    public final ExistingObjectReplicationStatus status() {
        return ExistingObjectReplicationStatus.fromValue(status);
    }
    ...
    public final String toString() {
        return ToString.builder("ExistingObjectReplication").add("Status", statusAsString()).build();
    }
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, ExistingObjectReplication> {
        /**
         * <p/>
         * 
         * @param status
