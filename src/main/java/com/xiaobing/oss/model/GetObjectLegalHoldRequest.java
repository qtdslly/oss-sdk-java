...
public final class GetObjectLegalHoldRequest extends S3Request implements
        ToCopyableBuilder<GetObjectLegalHoldRequest.Builder, GetObjectLegalHoldRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(GetObjectLegalHoldRequest::bucket))
    ...
    private static final SdkField<String> KEY_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Key")
            .getter(getter(GetObjectLegalHoldRequest::key))
    ...
    private static final SdkField<String> VERSION_ID_FIELD = SdkField
            ...
            .getter(getter(GetObjectLegalHoldRequest::versionId))
    ...
    private static final SdkField<String> REQUEST_PAYER_FIELD = SdkField
            ...
            .getter(getter(GetObjectLegalHoldRequest::requestPayerAsString))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(GetObjectLegalHoldRequest::expectedBucketOwner))
     ...
     * </p>
     * 
     * @return The key name for the object whose legal hold status you want to retrieve.
     */
     ...
     * </p>
     * 
     * @return The version ID of the object whose legal hold status you want to retrieve.
     */
    ...
    public final String toString() {
        return ToString.builder("GetObjectLegalHoldRequest").add("Bucket", bucket()).add("Key", key())
    ...
    private static <T> Function<Object, T> getter(Function<GetObjectLegalHoldRequest, T> g) {
        return obj -> g.apply((GetObjectLegalHoldRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, GetObjectLegalHoldRequest> {
        /**
         * <p>
         * The bucket name containing the object whose legal hold status you want to retrieve.
         * </p>
