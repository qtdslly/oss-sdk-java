...
public final class DeleteBucketAnalyticsConfigurationRequest extends S3Request implements
    ...
    private static final SdkField<String> BUCKET_FIELD = SdkField
            ...
            .memberName("Bucket")
            .getter(getter(DeleteBucketAnalyticsConfigurationRequest::bucket))
    ...
    private static final SdkField<String> ID_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Id")
            .getter(getter(DeleteBucketAnalyticsConfigurationRequest::id))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(DeleteBucketAnalyticsConfigurationRequest::expectedBucketOwner))
    ...
    public final String toString() {
        return ToString.builder("DeleteBucketAnalyticsConfigurationRequest").add("Bucket", bucket()).add("Id", id())
    ...
    private static <T> Function<Object, T> getter(Function<DeleteBucketAnalyticsConfigurationRequest, T> g) {
        return obj -> g.apply((DeleteBucketAnalyticsConfigurationRequest) obj);
    }
