...
public final class GetBucketInventoryConfigurationRequest extends S3Request implements
        ToCopyableBuilder<GetBucketInventoryConfigurationRequest.Builder, GetBucketInventoryConfigurationRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(GetBucketInventoryConfigurationRequest::bucket))
    ...
    private static final SdkField<String> ID_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Id")
            .getter(getter(GetBucketInventoryConfigurationRequest::id))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(GetBucketInventoryConfigurationRequest::expectedBucketOwner))
     ...
     * </p>
     * 
     * @return The name of the bucket containing the inventory configuration to retrieve.
     */
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        GetBucketInventoryConfigurationRequest other = (GetBucketInventoryConfigurationRequest) obj;
    ...
    public final String toString() {
        return ToString.builder("GetBucketInventoryConfigurationRequest").add("Bucket", bucket()).add("Id", id())
    ...
    private static <T> Function<Object, T> getter(Function<GetBucketInventoryConfigurationRequest, T> g) {
        return obj -> g.apply((GetBucketInventoryConfigurationRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, GetBucketInventoryConfigurationRequest> {
        /**
         * <p>
         * The name of the bucket containing the inventory configuration to retrieve.
         * </p>
