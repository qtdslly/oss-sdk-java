...
public final class AbortMultipartUploadRequest extends S3Request implements
        ToCopyableBuilder<AbortMultipartUploadRequest.Builder, AbortMultipartUploadRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(AbortMultipartUploadRequest::bucket))
    ...
    private static final SdkField<String> KEY_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Key")
            .getter(getter(AbortMultipartUploadRequest::key))
    ...
    private static final SdkField<String> UPLOAD_ID_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("UploadId")
            .getter(getter(AbortMultipartUploadRequest::uploadId))
    ...
    private static final SdkField<String> REQUEST_PAYER_FIELD = SdkField
            ...
            .getter(getter(AbortMultipartUploadRequest::requestPayerAsString))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(AbortMultipartUploadRequest::expectedBucketOwner))
    ...
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(BUCKET_FIELD, KEY_FIELD,
            UPLOAD_ID_FIELD, REQUEST_PAYER_FIELD, EXPECTED_BUCKET_OWNER_FIELD));
    ...
    public final String toString() {
        return ToString.builder("AbortMultipartUploadRequest").add("Bucket", bucket()).add("Key", key())
                .add("UploadId", uploadId()).add("RequestPayer", requestPayerAsString())
    ...
    private static <T> Function<Object, T> getter(Function<AbortMultipartUploadRequest, T> g) {
        return obj -> g.apply((AbortMultipartUploadRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, AbortMultipartUploadRequest> {
        /**
         * <p>
         * The bucket name to which the upload was taking place.
         * </p>
