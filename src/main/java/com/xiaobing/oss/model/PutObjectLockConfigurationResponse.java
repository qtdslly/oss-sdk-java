...
public final class PutObjectLockConfigurationResponse extends S3Response implements
        ToCopyableBuilder<PutObjectLockConfigurationResponse.Builder, PutObjectLockConfigurationResponse> {
    private static final SdkField<String> REQUEST_CHARGED_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("RequestCharged")
            .getter(getter(PutObjectLockConfigurationResponse::requestChargedAsString))
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        PutObjectLockConfigurationResponse other = (PutObjectLockConfigurationResponse) obj;
    ...
    public final String toString() {
        return ToString.builder("PutObjectLockConfigurationResponse").add("RequestCharged", requestChargedAsString()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<PutObjectLockConfigurationResponse, T> g) {
        return obj -> g.apply((PutObjectLockConfigurationResponse) obj);
    }
    ...
    public interface Builder extends S3Response.Builder, SdkPojo, CopyableBuilder<Builder, PutObjectLockConfigurationResponse> {
        /**
