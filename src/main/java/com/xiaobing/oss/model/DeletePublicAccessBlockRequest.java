...
public final class DeletePublicAccessBlockRequest extends S3Request implements
        ToCopyableBuilder<DeletePublicAccessBlockRequest.Builder, DeletePublicAccessBlockRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(DeletePublicAccessBlockRequest::bucket))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(DeletePublicAccessBlockRequest::expectedBucketOwner))
     ...
     * </p>
     * 
     * @return The Amazon S3 bucket whose <code>PublicAccessBlock</code> configuration you want to delete.
     */
    ...
    public final String toString() {
        return ToString.builder("DeletePublicAccessBlockRequest").add("Bucket", bucket())
    ...
    private static <T> Function<Object, T> getter(Function<DeletePublicAccessBlockRequest, T> g) {
        return obj -> g.apply((DeletePublicAccessBlockRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, DeletePublicAccessBlockRequest> {
        /**
         * <p>
         * The Amazon S3 bucket whose <code>PublicAccessBlock</code> configuration you want to delete.
         * </p>
