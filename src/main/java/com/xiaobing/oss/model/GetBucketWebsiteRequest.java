...
public final class GetBucketWebsiteRequest extends S3Request implements
        ToCopyableBuilder<GetBucketWebsiteRequest.Builder, GetBucketWebsiteRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(GetBucketWebsiteRequest::bucket))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(GetBucketWebsiteRequest::expectedBucketOwner))
     ...
     * </p>
     * 
     * @return The bucket name for which to get the website configuration.
     */
    ...
    public final String toString() {
        return ToString.builder("GetBucketWebsiteRequest").add("Bucket", bucket())
    ...
    private static <T> Function<Object, T> getter(Function<GetBucketWebsiteRequest, T> g) {
        return obj -> g.apply((GetBucketWebsiteRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, GetBucketWebsiteRequest> {
        /**
         * <p>
         * The bucket name for which to get the website configuration.
         * </p>
