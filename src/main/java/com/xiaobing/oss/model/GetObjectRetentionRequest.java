...
public final class GetObjectRetentionRequest extends S3Request implements
        ToCopyableBuilder<GetObjectRetentionRequest.Builder, GetObjectRetentionRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(GetObjectRetentionRequest::bucket))
    ...
    private static final SdkField<String> KEY_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Key")
            .getter(getter(GetObjectRetentionRequest::key))
    ...
    private static final SdkField<String> VERSION_ID_FIELD = SdkField
            ...
            .getter(getter(GetObjectRetentionRequest::versionId))
    ...
    private static final SdkField<String> REQUEST_PAYER_FIELD = SdkField
            ...
            .getter(getter(GetObjectRetentionRequest::requestPayerAsString))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(GetObjectRetentionRequest::expectedBucketOwner))
    ...
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(BUCKET_FIELD, KEY_FIELD,
            VERSION_ID_FIELD, REQUEST_PAYER_FIELD, EXPECTED_BUCKET_OWNER_FIELD));
     ...
     * </p>
     * 
     * @return The bucket name containing the object whose retention settings you want to retrieve. </p>
     *         <p>
     ...
     * </p>
     * 
     * @return The key name for the object whose retention settings you want to retrieve.
     */
     ...
     * </p>
     * 
     * @return The version ID for the object whose retention settings you want to retrieve.
     */
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        GetObjectRetentionRequest other = (GetObjectRetentionRequest) obj;
    ...
    public final String toString() {
        return ToString.builder("GetObjectRetentionRequest").add("Bucket", bucket()).add("Key", key())
    ...
    private static <T> Function<Object, T> getter(Function<GetObjectRetentionRequest, T> g) {
        return obj -> g.apply((GetObjectRetentionRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, GetObjectRetentionRequest> {
        /**
         * <p>
         * The bucket name containing the object whose retention settings you want to retrieve.
         * </p>
         ...
         * 
         * @param bucket
         *        The bucket name containing the object whose retention settings you want to retrieve. </p>
         *        <p>
