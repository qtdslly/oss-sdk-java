...
public final class GetBucketAnalyticsConfigurationRequest extends S3Request implements
        ToCopyableBuilder<GetBucketAnalyticsConfigurationRequest.Builder, GetBucketAnalyticsConfigurationRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(GetBucketAnalyticsConfigurationRequest::bucket))
    ...
    private static final SdkField<String> ID_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Id")
            .getter(getter(GetBucketAnalyticsConfigurationRequest::id))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(GetBucketAnalyticsConfigurationRequest::expectedBucketOwner))
     ...
     * </p>
     * 
     * @return The name of the bucket from which an analytics configuration is retrieved.
     */
    ...
    public final String toString() {
        return ToString.builder("GetBucketAnalyticsConfigurationRequest").add("Bucket", bucket()).add("Id", id())
    ...
    private static <T> Function<Object, T> getter(Function<GetBucketAnalyticsConfigurationRequest, T> g) {
        return obj -> g.apply((GetBucketAnalyticsConfigurationRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, GetBucketAnalyticsConfigurationRequest> {
        /**
         * <p>
         * The name of the bucket from which an analytics configuration is retrieved.
         * </p>
