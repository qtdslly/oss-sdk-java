...
public final class PutBucketCorsRequest extends S3Request implements
    ...
    private static final SdkField<String> CHECKSUM_ALGORITHM_FIELD = SdkField
            ...
            .getter(getter(PutBucketCorsRequest::checksumAlgorithmAsString))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(PutBucketCorsRequest::expectedBucketOwner))
    ...
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(BUCKET_FIELD,
            CORS_CONFIGURATION_FIELD, CONTENT_MD5_FIELD, CHECKSUM_ALGORITHM_FIELD, EXPECTED_BUCKET_OWNER_FIELD));
     ...
     *         Sharing</a> in the <i>Amazon S3 User Guide</i>.
     */
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, PutBucketCorsRequest> {
         ...
         * Sharing</a> in the <i>Amazon S3 User Guide</i>.
         * </p>
         * This is a convenience method that creates an instance of the {@link CORSConfiguration.Builder} avoiding the
         * need to create one manually via {@link CORSConfiguration#builder()}.
         *
         * <p>
