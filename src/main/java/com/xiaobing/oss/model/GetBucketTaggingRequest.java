...
public final class GetBucketTaggingRequest extends S3Request implements
        ToCopyableBuilder<GetBucketTaggingRequest.Builder, GetBucketTaggingRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(GetBucketTaggingRequest::bucket))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(GetBucketTaggingRequest::expectedBucketOwner))
     ...
     * </p>
     * 
     * @return The name of the bucket for which to get the tagging information.
     */
    ...
    public final String toString() {
        return ToString.builder("GetBucketTaggingRequest").add("Bucket", bucket())
    ...
    private static <T> Function<Object, T> getter(Function<GetBucketTaggingRequest, T> g) {
        return obj -> g.apply((GetBucketTaggingRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, GetBucketTaggingRequest> {
        /**
         * <p>
         * The name of the bucket for which to get the tagging information.
         * </p>
