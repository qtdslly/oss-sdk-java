...
public final class PutObjectAclResponse extends S3Response implements
        ToCopyableBuilder<PutObjectAclResponse.Builder, PutObjectAclResponse> {
    private static final SdkField<String> REQUEST_CHARGED_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("RequestCharged")
            .getter(getter(PutObjectAclResponse::requestChargedAsString))
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        PutObjectAclResponse other = (PutObjectAclResponse) obj;
    ...
    public final String toString() {
        return ToString.builder("PutObjectAclResponse").add("RequestCharged", requestChargedAsString()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<PutObjectAclResponse, T> g) {
        return obj -> g.apply((PutObjectAclResponse) obj);
    }
    ...
    public interface Builder extends S3Response.Builder, SdkPojo, CopyableBuilder<Builder, PutObjectAclResponse> {
        /**
