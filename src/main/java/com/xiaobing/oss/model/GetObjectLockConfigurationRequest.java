...
public final class GetObjectLockConfigurationRequest extends S3Request implements
        ToCopyableBuilder<GetObjectLockConfigurationRequest.Builder, GetObjectLockConfigurationRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(GetObjectLockConfigurationRequest::bucket))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(GetObjectLockConfigurationRequest::expectedBucketOwner))
     ...
     * </p>
     * 
     * @return The bucket whose Object Lock configuration you want to retrieve.</p>
     *         <p>
    ...
    public final String toString() {
        return ToString.builder("GetObjectLockConfigurationRequest").add("Bucket", bucket())
    ...
    private static <T> Function<Object, T> getter(Function<GetObjectLockConfigurationRequest, T> g) {
        return obj -> g.apply((GetObjectLockConfigurationRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, GetObjectLockConfigurationRequest> {
        /**
         * <p>
         * The bucket whose Object Lock configuration you want to retrieve.
         * </p>
         ...
         * 
         * @param bucket
         *        The bucket whose Object Lock configuration you want to retrieve.</p>
         *        <p>
