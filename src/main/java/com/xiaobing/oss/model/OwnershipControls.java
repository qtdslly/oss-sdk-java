...
public final class OwnershipControls implements SdkPojo, Serializable,
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, OwnershipControls> {
         ...
         * {@link OwnershipControlsRule.Builder} avoiding the need to create
         * one manually via {@link OwnershipControlsRule#builder()}.
         *
         * <p>
         * When the {@link Consumer} completes,
         * {@link OwnershipControlsRule.Builder#build()} is called immediately
         * and its result is passed to {@link #rules(List<OwnershipControlsRule>)}.
         * 
         * @param rules
         *        a consumer that will call methods on
         *        {@link OwnershipControlsRule.Builder}
         * @return Returns a reference to this object so that method calls can be chained together.
         * @see #rules(Collection<OwnershipControlsRule>)
         */
