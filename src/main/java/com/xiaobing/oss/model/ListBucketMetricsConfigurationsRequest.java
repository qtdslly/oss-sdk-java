...
public final class ListBucketMetricsConfigurationsRequest extends S3Request implements
    ...
    private static <T> Function<Object, T> getter(Function<ListBucketMetricsConfigurationsRequest, T> g) {
        return obj -> g.apply((ListBucketMetricsConfigurationsRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, ListBucketMetricsConfigurationsRequest> {
        /**
         * <p>
         * The name of the bucket containing the metrics configurations to retrieve.
         * </p>
