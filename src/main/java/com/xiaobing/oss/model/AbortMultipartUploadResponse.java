...
public final class AbortMultipartUploadResponse extends S3Response implements
    ...
    private static final SdkField<String> REQUEST_CHARGED_FIELD = SdkField
            ...
            .getter(getter(AbortMultipartUploadResponse::requestChargedAsString))
    ...
    public final String toString() {
        return ToString.builder("AbortMultipartUploadResponse").add("RequestCharged", requestChargedAsString()).build();
    }
    ...
    private static <T> Function<Object, T> getter(Function<AbortMultipartUploadResponse, T> g) {
        return obj -> g.apply((AbortMultipartUploadResponse) obj);
    }
    ...
    public interface Builder extends S3Response.Builder, SdkPojo, CopyableBuilder<Builder, AbortMultipartUploadResponse> {
        /**
