 ...
 * least two predicates in any combination, and an object must match all of the predicates for the filter to apply.
 * </p>
 */
@Generated("software.amazon.awssdk:codegen")
public final class AnalyticsAndOperator implements SdkPojo, Serializable,
        ToCopyableBuilder<AnalyticsAndOperator.Builder, AnalyticsAndOperator> {
    private static final SdkField<String> PREFIX_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Prefix")
            .getter(getter(AnalyticsAndOperator::prefix))
    ...
    private static final SdkField<List<Tag>> TAGS_FIELD = SdkField
            ...
            .memberName("Tags")
            .getter(getter(AnalyticsAndOperator::tags))
     ...
     * </p>
     * 
     * @return The prefix to use when evaluating an AND predicate: The prefix that an object must have to be included in
     *         the metrics results.
     */
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, AnalyticsAndOperator> {
         ...
         * 
         * @param prefix
         *        The prefix to use when evaluating an AND predicate: The prefix that an object must have to be included
