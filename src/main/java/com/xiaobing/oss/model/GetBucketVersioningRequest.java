...
public final class GetBucketVersioningRequest extends S3Request implements
        ToCopyableBuilder<GetBucketVersioningRequest.Builder, GetBucketVersioningRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(GetBucketVersioningRequest::bucket))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(GetBucketVersioningRequest::expectedBucketOwner))
     ...
     * </p>
     * 
     * @return The name of the bucket for which to get the versioning information.
     */
    ...
    public final String toString() {
        return ToString.builder("GetBucketVersioningRequest").add("Bucket", bucket())
    ...
    private static <T> Function<Object, T> getter(Function<GetBucketVersioningRequest, T> g) {
        return obj -> g.apply((GetBucketVersioningRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, GetBucketVersioningRequest> {
        /**
         * <p>
         * The name of the bucket for which to get the versioning information.
         * </p>
