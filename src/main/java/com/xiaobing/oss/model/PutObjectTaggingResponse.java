...
public final class PutObjectTaggingResponse extends S3Response implements
    ...
    private static final SdkField<String> VERSION_ID_FIELD = SdkField
            ...
            .getter(getter(PutObjectTaggingResponse::versionId))
     ...
     * </p>
     * 
     * @return The versionId of the object the tag-set was added to.
     */
    ...
    private static <T> Function<Object, T> getter(Function<PutObjectTaggingResponse, T> g) {
        return obj -> g.apply((PutObjectTaggingResponse) obj);
    }
    ...
    public interface Builder extends S3Response.Builder, SdkPojo, CopyableBuilder<Builder, PutObjectTaggingResponse> {
        /**
         * <p>
         * The versionId of the object the tag-set was added to.
         * </p>
