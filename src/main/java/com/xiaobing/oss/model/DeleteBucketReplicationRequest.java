...
public final class DeleteBucketReplicationRequest extends S3Request implements
        ToCopyableBuilder<DeleteBucketReplicationRequest.Builder, DeleteBucketReplicationRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(DeleteBucketReplicationRequest::bucket))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(DeleteBucketReplicationRequest::expectedBucketOwner))
    ...
    public final String toString() {
        return ToString.builder("DeleteBucketReplicationRequest").add("Bucket", bucket())
    ...
    private static <T> Function<Object, T> getter(Function<DeleteBucketReplicationRequest, T> g) {
        return obj -> g.apply((DeleteBucketReplicationRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, DeleteBucketReplicationRequest> {
        /**
         * <p>
         * The bucket name.
         * </p>
