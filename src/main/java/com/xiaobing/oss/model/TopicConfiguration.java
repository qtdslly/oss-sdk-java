...
public final class TopicConfiguration implements SdkPojo, Serializable,
    ...
    private static final SdkField<String> ID_FIELD = SdkField
            ...
            .memberName("Id")
            .getter(getter(TopicConfiguration::id))
            .setter(setter(Builder::id))
            .traits(LocationTrait.builder().location(MarshallLocation.PAYLOAD).locationName("Id").unmarshallLocationName("Id")
                    .build()).build();

    private static final SdkField<String> TOPIC_ARN_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("TopicArn")
            .getter(getter(TopicConfiguration::topicArn))
    ...
    private static final SdkField<List<String>> EVENTS_FIELD = SdkField
            ...
            .memberName("Events")
            .getter(getter(TopicConfiguration::eventsAsStrings))
    ...
    private static final SdkField<NotificationConfigurationFilter> FILTER_FIELD = SdkField
            ...
            .memberName("Filter")
            .getter(getter(TopicConfiguration::filter))
    ...
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(ID_FIELD, TOPIC_ARN_FIELD,
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the Amazon SNS topic to which Amazon S3 publishes a message when it
    ...
    /**
     * <p>
     * The Amazon S3 bucket event about which to send notifications. For more information, see <a
     ...
     * </p>
     * 
     * @return The Amazon S3 bucket event about which to send notifications. For more information, see <a
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        return Objects.equals(id(), other.id()) && Objects.equals(topicArn(), other.topicArn())
    ...
    public final String toString() {
        return ToString.builder("TopicConfiguration").add("Id", id()).add("TopicArn", topicArn())
