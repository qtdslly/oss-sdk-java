...
public final class GetObjectAclRequest extends S3Request implements
        ToCopyableBuilder<GetObjectAclRequest.Builder, GetObjectAclRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(GetObjectAclRequest::bucket))
    ...
    private static final SdkField<String> KEY_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Key")
            .getter(getter(GetObjectAclRequest::key))
    ...
    private static final SdkField<String> VERSION_ID_FIELD = SdkField
            ...
            .getter(getter(GetObjectAclRequest::versionId))
    ...
    private static final SdkField<String> REQUEST_PAYER_FIELD = SdkField
            ...
            .getter(getter(GetObjectAclRequest::requestPayerAsString))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(GetObjectAclRequest::expectedBucketOwner))
     ...
     * </p>
     * 
     * @return The key of the object for which to get the ACL information.
     */
    ...
    public final String toString() {
        return ToString.builder("GetObjectAclRequest").add("Bucket", bucket()).add("Key", key()).add("VersionId", versionId())
    ...
    private static <T> Function<Object, T> getter(Function<GetObjectAclRequest, T> g) {
        return obj -> g.apply((GetObjectAclRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, GetObjectAclRequest> {
        /**
         * <p>
         * The bucket name that contains the object for which to get the ACL information.
         * </p>
