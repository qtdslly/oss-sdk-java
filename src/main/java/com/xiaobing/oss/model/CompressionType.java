...
public enum CompressionType {
    ...
    private static final Map<String, CompressionType> VALUE_MAP = EnumUtils.uniqueIndex(CompressionType.class,
     ...
     * @param value
     *        real value
     * @return CompressionType corresponding to the value
     */
