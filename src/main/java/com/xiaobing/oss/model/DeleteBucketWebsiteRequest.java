...
public final class DeleteBucketWebsiteRequest extends S3Request implements
        ToCopyableBuilder<DeleteBucketWebsiteRequest.Builder, DeleteBucketWebsiteRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(DeleteBucketWebsiteRequest::bucket))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(DeleteBucketWebsiteRequest::expectedBucketOwner))
     ...
     * </p>
     * 
     * @return The bucket name for which you want to remove the website configuration.
     */
    ...
    public final String toString() {
        return ToString.builder("DeleteBucketWebsiteRequest").add("Bucket", bucket())
    ...
    private static <T> Function<Object, T> getter(Function<DeleteBucketWebsiteRequest, T> g) {
        return obj -> g.apply((DeleteBucketWebsiteRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, DeleteBucketWebsiteRequest> {
        /**
         * <p>
         * The bucket name for which you want to remove the website configuration.
         * </p>
