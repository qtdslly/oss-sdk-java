...
public final class RequestPaymentConfiguration implements SdkPojo, Serializable,
    ...
    private static final SdkField<String> PAYER_FIELD = SdkField
            ...
            .memberName("Payer")
            .getter(getter(RequestPaymentConfiguration::payerAsString))
    ...
    public interface Builder extends SdkPojo, CopyableBuilder<Builder, RequestPaymentConfiguration> {
        /**
         * <p>
         * Specifies who pays for the download and request fees.
         * </p>
