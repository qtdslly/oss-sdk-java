...
public final class PutBucketRequestPaymentRequest extends S3Request implements
    ...
    private static final SdkField<String> CHECKSUM_ALGORITHM_FIELD = SdkField
            ...
            .getter(getter(PutBucketRequestPaymentRequest::checksumAlgorithmAsString))
    ...
    private static final SdkField<RequestPaymentConfiguration> REQUEST_PAYMENT_CONFIGURATION_FIELD = SdkField
            ...
            .memberName("RequestPaymentConfiguration")
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(PutBucketRequestPaymentRequest::expectedBucketOwner))
    ...
    private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(BUCKET_FIELD,
            CONTENT_MD5_FIELD, CHECKSUM_ALGORITHM_FIELD, REQUEST_PAYMENT_CONFIGURATION_FIELD, EXPECTED_BUCKET_OWNER_FIELD));
    ...
    public final String toString() {
        return ToString.builder("PutBucketRequestPaymentRequest").add("Bucket", bucket()).add("ContentMD5", contentMD5())
                ...
                .add("RequestPaymentConfiguration", requestPaymentConfiguration())
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, PutBucketRequestPaymentRequest> {
         ...
         * Container for Payer.
         * </p>
         * This is a convenience method that creates an instance of the {@link RequestPaymentConfiguration.Builder}
         * avoiding the need to create one manually via {@link RequestPaymentConfiguration#builder()}.
         *
         * <p>
