...
public final class DeleteBucketPolicyResponse extends S3Response implements
        ToCopyableBuilder<DeleteBucketPolicyResponse.Builder, DeleteBucketPolicyResponse> {
    ...
    public final boolean equalsBySdkFields(Object obj) {
        ...
        if (!(obj instanceof DeleteBucketPolicyResponse)) {
            return false;
        }
        return true;
    }
