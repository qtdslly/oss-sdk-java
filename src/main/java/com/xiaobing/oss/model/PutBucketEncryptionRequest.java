...
public final class PutBucketEncryptionRequest extends S3Request implements
        ToCopyableBuilder<PutBucketEncryptionRequest.Builder, PutBucketEncryptionRequest> {
     ...
     * customer managed keys (SSE-KMS). For information about the Amazon S3 default encryption feature, see <a
     ...
     * </p>
     * 
     * @return Specifies default encryption for a bucket using server-side encryption with Amazon S3-managed keys
     *         (SSE-S3) or customer managed keys (SSE-KMS). For information about the Amazon S3 default encryption
     *         feature, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/bucket-encryption.html">Amazon S3
     *         Default Bucket Encryption</a> in the <i>Amazon S3 User Guide</i>.
     */
     ...
     * </p>
     * 
     * @return The base64-encoded 128-bit MD5 digest of the server-side encryption configuration.</p>
     *         <p>
    ...
    public final String toString() {
        return ToString.builder("PutBucketEncryptionRequest").add("Bucket", bucket()).add("ContentMD5", contentMD5())
    ...
    private static <T> Function<Object, T> getter(Function<PutBucketEncryptionRequest, T> g) {
        return obj -> g.apply((PutBucketEncryptionRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, PutBucketEncryptionRequest> {
        /**
         * <p>
         * Specifies default encryption for a bucket using server-side encryption with Amazon S3-managed keys (SSE-S3)
         * or customer managed keys (SSE-KMS). For information about the Amazon S3 default encryption feature, see <a
         * href="https://docs.aws.amazon.com/AmazonS3/latest/dev/bucket-encryption.html">Amazon S3 Default Bucket
         * Encryption</a> in the <i>Amazon S3 User Guide</i>.
         * </p>
         * 
         ...
         * 
         * @param contentMD5
         *        The base64-encoded 128-bit MD5 digest of the server-side encryption configuration.</p>
         *        <p>
