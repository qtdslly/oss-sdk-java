...
public final class ListBucketAnalyticsConfigurationsRequest extends S3Request implements
    ...
    private static final SdkField<String> BUCKET_FIELD = SdkField
            ...
            .memberName("Bucket")
            .getter(getter(ListBucketAnalyticsConfigurationsRequest::bucket))
    ...
    private static final SdkField<String> CONTINUATION_TOKEN_FIELD = SdkField
            ...
            .getter(getter(ListBucketAnalyticsConfigurationsRequest::continuationToken))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(ListBucketAnalyticsConfigurationsRequest::expectedBucketOwner))
    ...
    private static <T> Function<Object, T> getter(Function<ListBucketAnalyticsConfigurationsRequest, T> g) {
        return obj -> g.apply((ListBucketAnalyticsConfigurationsRequest) obj);
    }
