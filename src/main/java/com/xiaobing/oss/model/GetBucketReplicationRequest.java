...
public final class GetBucketReplicationRequest extends S3Request implements
        ToCopyableBuilder<GetBucketReplicationRequest.Builder, GetBucketReplicationRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(GetBucketReplicationRequest::bucket))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(GetBucketReplicationRequest::expectedBucketOwner))
     ...
     * </p>
     * 
     * @return The bucket name for which to get the replication information.
     */
    ...
    public final String toString() {
        return ToString.builder("GetBucketReplicationRequest").add("Bucket", bucket())
    ...
    private static <T> Function<Object, T> getter(Function<GetBucketReplicationRequest, T> g) {
        return obj -> g.apply((GetBucketReplicationRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, GetBucketReplicationRequest> {
        /**
         * <p>
         * The bucket name for which to get the replication information.
         * </p>
