...
public final class DeleteBucketPolicyRequest extends S3Request implements
        ToCopyableBuilder<DeleteBucketPolicyRequest.Builder, DeleteBucketPolicyRequest> {
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(DeleteBucketPolicyRequest::expectedBucketOwner))
    ...
    public final String toString() {
        return ToString.builder("DeleteBucketPolicyRequest").add("Bucket", bucket())
    ...
    private static <T> Function<Object, T> getter(Function<DeleteBucketPolicyRequest, T> g) {
        return obj -> g.apply((DeleteBucketPolicyRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, DeleteBucketPolicyRequest> {
        /**
         * <p>
         * The bucket name.
         * </p>
