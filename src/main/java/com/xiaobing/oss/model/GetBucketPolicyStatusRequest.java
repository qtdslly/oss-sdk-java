...
public final class GetBucketPolicyStatusRequest extends S3Request implements
        ToCopyableBuilder<GetBucketPolicyStatusRequest.Builder, GetBucketPolicyStatusRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(GetBucketPolicyStatusRequest::bucket))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(GetBucketPolicyStatusRequest::expectedBucketOwner))
     ...
     * </p>
     * 
     * @return The name of the Amazon S3 bucket whose policy status you want to retrieve.
     */
    ...
    public final String toString() {
        return ToString.builder("GetBucketPolicyStatusRequest").add("Bucket", bucket())
    ...
    private static <T> Function<Object, T> getter(Function<GetBucketPolicyStatusRequest, T> g) {
        return obj -> g.apply((GetBucketPolicyStatusRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, GetBucketPolicyStatusRequest> {
        /**
         * <p>
         * The name of the Amazon S3 bucket whose policy status you want to retrieve.
         * </p>
