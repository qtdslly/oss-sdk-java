...
public final class GetBucketPolicyRequest extends S3Request implements
        ToCopyableBuilder<GetBucketPolicyRequest.Builder, GetBucketPolicyRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(GetBucketPolicyRequest::bucket))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(GetBucketPolicyRequest::expectedBucketOwner))
     ...
     * </p>
     * 
     * @return The bucket name for which to get the bucket policy.
     */
    ...
    public final String toString() {
        return ToString.builder("GetBucketPolicyRequest").add("Bucket", bucket())
    ...
    private static <T> Function<Object, T> getter(Function<GetBucketPolicyRequest, T> g) {
        return obj -> g.apply((GetBucketPolicyRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, GetBucketPolicyRequest> {
        /**
         * <p>
         * The bucket name for which to get the bucket policy.
         * </p>
