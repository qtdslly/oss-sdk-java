...
public final class DeleteBucketMetricsConfigurationRequest extends S3Request implements
        ToCopyableBuilder<DeleteBucketMetricsConfigurationRequest.Builder, DeleteBucketMetricsConfigurationRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(DeleteBucketMetricsConfigurationRequest::bucket))
    ...
    private static final SdkField<String> ID_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Id")
            .getter(getter(DeleteBucketMetricsConfigurationRequest::id))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(DeleteBucketMetricsConfigurationRequest::expectedBucketOwner))
     ...
     * </p>
     * 
     * @return The name of the bucket containing the metrics configuration to delete.
     */
    ...
    public final String toString() {
        return ToString.builder("DeleteBucketMetricsConfigurationRequest").add("Bucket", bucket()).add("Id", id())
    ...
    private static <T> Function<Object, T> getter(Function<DeleteBucketMetricsConfigurationRequest, T> g) {
        return obj -> g.apply((DeleteBucketMetricsConfigurationRequest) obj);
    }
