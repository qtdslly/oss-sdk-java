...
public final class GetBucketLoggingRequest extends S3Request implements
        ToCopyableBuilder<GetBucketLoggingRequest.Builder, GetBucketLoggingRequest> {
    private static final SdkField<String> BUCKET_FIELD = SdkField
            .<String> builder(MarshallingType.STRING)
            .memberName("Bucket")
            .getter(getter(GetBucketLoggingRequest::bucket))
    ...
    private static final SdkField<String> EXPECTED_BUCKET_OWNER_FIELD = SdkField
            ...
            .getter(getter(GetBucketLoggingRequest::expectedBucketOwner))
     ...
     * </p>
     * 
     * @return The bucket name for which to get the logging information.
     */
    ...
    public final String toString() {
        return ToString.builder("GetBucketLoggingRequest").add("Bucket", bucket())
    ...
    private static <T> Function<Object, T> getter(Function<GetBucketLoggingRequest, T> g) {
        return obj -> g.apply((GetBucketLoggingRequest) obj);
    }
    ...
    public interface Builder extends S3Request.Builder, SdkPojo, CopyableBuilder<Builder, GetBucketLoggingRequest> {
        /**
         * <p>
         * The bucket name for which to get the logging information.
         * </p>
