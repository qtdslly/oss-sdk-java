...
public interface S3AsyncWaiter extends SdkAutoCloseable {
    /**
     * Polls {@link S3AsyncClient#headBucket} API until the desired condition {@code BucketExists} is met, or until it
     ...
     *         desired state.
     */
    default CompletableFuture<WaiterResponse<HeadBucketResponse>> waitUntilBucketExists(HeadBucketRequest headBucketRequest) {
     ...
     */
    default CompletableFuture<WaiterResponse<HeadBucketResponse>> waitUntilBucketExists(
            Consumer<HeadBucketRequest.Builder> headBucketRequest) {
     ...
     */
    default CompletableFuture<WaiterResponse<HeadBucketResponse>> waitUntilBucketExists(
            Consumer<HeadBucketRequest.Builder> headBucketRequest, Consumer<WaiterOverrideConfiguration.Builder> overrideConfig) {
        return waitUntilBucketExists(HeadBucketRequest.builder().applyMutation(headBucketRequest).build(),
                WaiterOverrideConfiguration.builder().applyMutation(overrideConfig).build());
    }

    /**
     * Polls {@link S3AsyncClient#headBucket} API until the desired condition {@code BucketNotExists} is met, or until
     ...
     *         desired state.
     */
    default CompletableFuture<WaiterResponse<HeadBucketResponse>> waitUntilBucketNotExists(HeadBucketRequest headBucketRequest) {
        throw new UnsupportedOperationException();
    }
     ...
     *         with the waiter success condition
     */
    default CompletableFuture<WaiterResponse<HeadBucketResponse>> waitUntilBucketNotExists(
            Consumer<HeadBucketRequest.Builder> headBucketRequest) {
    ...
    /**
     * Polls {@link S3AsyncClient#headObject} API until the desired condition {@code ObjectExists} is met, or until it
     * is determined that the resource will never enter into the desired state
     *
     ...
     *         desired state.
     */
    default CompletableFuture<WaiterResponse<HeadObjectResponse>> waitUntilObjectExists(HeadObjectRequest headObjectRequest) {
        throw new UnsupportedOperationException();
    }
     ...
     *         with the waiter success condition
     */
    default CompletableFuture<WaiterResponse<HeadObjectResponse>> waitUntilObjectExists(
    ...
    /**
     * Polls {@link S3AsyncClient#headObject} API until the desired condition {@code ObjectNotExists} is met, or until
     * it is determined that the resource will never enter into the desired state
     *
     * @param headObjectRequest
     *        the request to be used for polling
     ...
     *         desired state.
     */
    default CompletableFuture<WaiterResponse<HeadObjectResponse>> waitUntilObjectNotExists(HeadObjectRequest headObjectRequest) {
        throw new UnsupportedOperationException();
    }
     ...
     *         with the waiter success condition
     */
    default CompletableFuture<WaiterResponse<HeadObjectResponse>> waitUntilObjectNotExists(
            Consumer<HeadObjectRequest.Builder> headObjectRequest) {
    ...
    /**
     * Create a builder that can be used to configure and create a {@link S3AsyncWaiter}.
     *
     * @return a builder
     */
    ...
    /**
     * Create an instance of {@link S3AsyncWaiter} with the default configuration.
     * <p>
     * <b>A default {@link S3AsyncClient} will be created to poll resources. It is recommended to share a single
    ...
    interface Builder {
        ...
        /**
         * Sets a custom {@link S3AsyncClient} that will be used to poll the resource
         * <p>
         ...
         * @return a reference to this object so that method calls can be chained together.
         */
        Builder client(S3AsyncClient client);

        /**
         * Builds an instance of {@link S3AsyncWaiter} based on the configurations supplied to this builder
         *
         * @return An initialized {@link S3AsyncWaiter}
         */
        S3AsyncWaiter build();
    }
}
