...
package com.xiaobing.oss.presigner;

import java.net.URI;
import java.net.URLConnection;
import java.util.function.Consumer;

import com.xiaobing.oss.S3Configuration;
import com.xiaobing.oss.presigner.model.PresignedCompleteMultipartUploadRequest;
import com.xiaobing.oss.presigner.model.PresignedCreateMultipartUploadRequest;
...
import com.xiaobing.oss.internal.signing.DefaultS3Presigner;
...
import com.xiaobing.oss.presigner.model.AbortMultipartUploadPresignRequest;
import com.xiaobing.oss.presigner.model.CompleteMultipartUploadPresignRequest;
import com.xiaobing.oss.presigner.model.CreateMultipartUploadPresignRequest;
import com.xiaobing.oss.presigner.model.GetObjectPresignRequest;
import com.xiaobing.oss.presigner.model.PresignedAbortMultipartUploadRequest;
import com.xiaobing.oss.presigner.model.PresignedGetObjectRequest;
import com.xiaobing.oss.presigner.model.PresignedPutObjectRequest;
import com.xiaobing.oss.presigner.model.PresignedUploadPartRequest;
import com.xiaobing.oss.presigner.model.PutObjectPresignRequest;
import com.xiaobing.oss.presigner.model.UploadPartPresignRequest;
...
public interface S3Presigner extends SdkPresigner {
    ...
    /**
     * Create an {@link Builder} that can be used to configure and create a {@link S3Presigner}.
     * <p/>
     * This is usually done at application startup, because creating a presigner can be expensive. It is recommended to
     * {@link #close()} the {@code S3Presigner} when it is done being used.
     */
