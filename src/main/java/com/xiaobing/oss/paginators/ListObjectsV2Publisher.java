 ...
 * {@link S3AsyncClient#listObjectsV2Paginator(ListObjectsV2Request)}
 * operation which is a paginated operation. This class is a type of {@link org.reactivestreams.Publisher} which can be
 * used to provide a sequence of {@link ListObjectsV2Response} response pages
 * as per demand from the subscriber.
 * </p>
 * <p>
...
public class ListObjectsV2Publisher implements SdkPublisher<ListObjectsV2Response> {
    ...
    public final SdkPublisher<S3Object> contents() {
        ...
        return PaginatedItemsPublisher.builder().nextPageFetcher(new ListObjectsV2ResponseFetcher())
