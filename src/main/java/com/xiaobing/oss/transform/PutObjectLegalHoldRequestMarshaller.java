...
/**
 * {@link PutObjectLegalHoldRequest} Marshaller
 */
@Generated("software.amazon.awssdk:codegen")
@SdkInternalApi
public class PutObjectLegalHoldRequestMarshaller implements Marshaller<PutObjectLegalHoldRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().requestUri("/{Bucket}/{Key+}?legal-hold")
    ...
    public SdkHttpFullRequest marshall(PutObjectLegalHoldRequest putObjectLegalHoldRequest) {
        Validate.paramNotNull(putObjectLegalHoldRequest, "putObjectLegalHoldRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(putObjectLegalHoldRequest);
        } catch (Exception e) {
