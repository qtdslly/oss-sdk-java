...
/**
 * {@link GetBucketLoggingRequest} Marshaller
 */
@Generated("software.amazon.awssdk:codegen")
@SdkInternalApi
public class GetBucketLoggingRequestMarshaller implements Marshaller<GetBucketLoggingRequest> {
    ...
    public SdkHttpFullRequest marshall(GetBucketLoggingRequest getBucketLoggingRequest) {
        Validate.paramNotNull(getBucketLoggingRequest, "getBucketLoggingRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(getBucketLoggingRequest);
        } catch (Exception e) {
