...
/**
 * {@link PutBucketLoggingRequest} Marshaller
 */
@Generated("software.amazon.awssdk:codegen")
@SdkInternalApi
public class PutBucketLoggingRequestMarshaller implements Marshaller<PutBucketLoggingRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().requestUri("/{Bucket}?logging")
    ...
    public SdkHttpFullRequest marshall(PutBucketLoggingRequest putBucketLoggingRequest) {
        Validate.paramNotNull(putBucketLoggingRequest, "putBucketLoggingRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(putBucketLoggingRequest);
        } catch (Exception e) {
