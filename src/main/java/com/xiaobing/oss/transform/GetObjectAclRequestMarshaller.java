...
/**
 * {@link GetObjectAclRequest} Marshaller
 */
@Generated("software.amazon.awssdk:codegen")
@SdkInternalApi
public class GetObjectAclRequestMarshaller implements Marshaller<GetObjectAclRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().requestUri("/{Bucket}/{Key+}?acl")
    ...
    public SdkHttpFullRequest marshall(GetObjectAclRequest getObjectAclRequest) {
        Validate.paramNotNull(getObjectAclRequest, "getObjectAclRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(getObjectAclRequest);
        } catch (Exception e) {
