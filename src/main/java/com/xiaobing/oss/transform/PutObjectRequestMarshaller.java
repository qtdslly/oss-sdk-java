...
/**
 * {@link PutObjectRequest} Marshaller
 */
@Generated("software.amazon.awssdk:codegen")
@SdkInternalApi
public class PutObjectRequestMarshaller implements Marshaller<PutObjectRequest> {
    ...
    public SdkHttpFullRequest marshall(PutObjectRequest putObjectRequest) {
        Validate.paramNotNull(putObjectRequest, "putObjectRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(putObjectRequest);
        } catch (Exception e) {
