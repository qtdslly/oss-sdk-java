...
/**
 * {@link ListMultipartUploadsRequest} Marshaller
 */
@Generated("software.amazon.awssdk:codegen")
@SdkInternalApi
public class ListMultipartUploadsRequestMarshaller implements Marshaller<ListMultipartUploadsRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().requestUri("/{Bucket}?uploads")
