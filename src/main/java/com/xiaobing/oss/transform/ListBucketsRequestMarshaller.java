...
/**
 * {@link ListBucketsRequest} Marshaller
 */
@Generated("software.amazon.awssdk:codegen")
@SdkInternalApi
public class ListBucketsRequestMarshaller implements Marshaller<ListBucketsRequest> {
    ...
    public SdkHttpFullRequest marshall(ListBucketsRequest listBucketsRequest) {
        Validate.paramNotNull(listBucketsRequest, "listBucketsRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(listBucketsRequest);
        } catch (Exception e) {
