...
/**
 * {@link GetBucketCorsRequest} Marshaller
 */
@Generated("software.amazon.awssdk:codegen")
@SdkInternalApi
public class GetBucketCorsRequestMarshaller implements Marshaller<GetBucketCorsRequest> {
    ...
    public SdkHttpFullRequest marshall(GetBucketCorsRequest getBucketCorsRequest) {
        Validate.paramNotNull(getBucketCorsRequest, "getBucketCorsRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(getBucketCorsRequest);
        } catch (Exception e) {
