...
/**
 * {@link GetBucketTaggingRequest} Marshaller
 */
@Generated("software.amazon.awssdk:codegen")
@SdkInternalApi
public class GetBucketTaggingRequestMarshaller implements Marshaller<GetBucketTaggingRequest> {
    ...
    public SdkHttpFullRequest marshall(GetBucketTaggingRequest getBucketTaggingRequest) {
        Validate.paramNotNull(getBucketTaggingRequest, "getBucketTaggingRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(getBucketTaggingRequest);
        } catch (Exception e) {
