...
/**
 * {@link GetBucketLocationRequest} Marshaller
 */
@Generated("software.amazon.awssdk:codegen")
@SdkInternalApi
public class GetBucketLocationRequestMarshaller implements Marshaller<GetBucketLocationRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().requestUri("/{Bucket}?location")
