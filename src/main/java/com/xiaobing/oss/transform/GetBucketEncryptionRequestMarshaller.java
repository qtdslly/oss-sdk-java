...
/**
 * {@link GetBucketEncryptionRequest} Marshaller
 */
@Generated("software.amazon.awssdk:codegen")
@SdkInternalApi
public class GetBucketEncryptionRequestMarshaller implements Marshaller<GetBucketEncryptionRequest> {
    ...
    public SdkHttpFullRequest marshall(GetBucketEncryptionRequest getBucketEncryptionRequest) {
        Validate.paramNotNull(getBucketEncryptionRequest, "getBucketEncryptionRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(getBucketEncryptionRequest);
        } catch (Exception e) {
