...
/**
 * {@link DeleteBucketInventoryConfigurationRequest} Marshaller
 */
@Generated("software.amazon.awssdk:codegen")
@SdkInternalApi
public class DeleteBucketInventoryConfigurationRequestMarshaller implements Marshaller<DeleteBucketInventoryConfigurationRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().requestUri("/{Bucket}?inventory")
    ...
    public SdkHttpFullRequest marshall(DeleteBucketInventoryConfigurationRequest deleteBucketInventoryConfigurationRequest) {
        Validate.paramNotNull(deleteBucketInventoryConfigurationRequest, "deleteBucketInventoryConfigurationRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(deleteBucketInventoryConfigurationRequest);
        } catch (Exception e) {
