...
/**
 * {@link PutObjectTaggingRequest} Marshaller
 */
@Generated("software.amazon.awssdk:codegen")
@SdkInternalApi
public class PutObjectTaggingRequestMarshaller implements Marshaller<PutObjectTaggingRequest> {
    ...
    public SdkHttpFullRequest marshall(PutObjectTaggingRequest putObjectTaggingRequest) {
        Validate.paramNotNull(putObjectTaggingRequest, "putObjectTaggingRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(putObjectTaggingRequest);
        } catch (Exception e) {
