...
/**
 * {@link ListBucketMetricsConfigurationsRequest} Marshaller
 */
@Generated("software.amazon.awssdk:codegen")
@SdkInternalApi
public class ListBucketMetricsConfigurationsRequestMarshaller implements Marshaller<ListBucketMetricsConfigurationsRequest> {
    ...
    public SdkHttpFullRequest marshall(ListBucketMetricsConfigurationsRequest listBucketMetricsConfigurationsRequest) {
        Validate.paramNotNull(listBucketMetricsConfigurationsRequest, "listBucketMetricsConfigurationsRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(listBucketMetricsConfigurationsRequest);
        } catch (Exception e) {
