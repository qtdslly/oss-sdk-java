...
/**
 * {@link GetBucketOwnershipControlsRequest} Marshaller
 */
@Generated("software.amazon.awssdk:codegen")
@SdkInternalApi
public class GetBucketOwnershipControlsRequestMarshaller implements Marshaller<GetBucketOwnershipControlsRequest> {
    ...
    public SdkHttpFullRequest marshall(GetBucketOwnershipControlsRequest getBucketOwnershipControlsRequest) {
        Validate.paramNotNull(getBucketOwnershipControlsRequest, "getBucketOwnershipControlsRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(getBucketOwnershipControlsRequest);
        } catch (Exception e) {
