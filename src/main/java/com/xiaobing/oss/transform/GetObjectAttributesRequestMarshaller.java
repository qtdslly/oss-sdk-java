...
/**
 * {@link GetObjectAttributesRequest} Marshaller
 */
@Generated("software.amazon.awssdk:codegen")
@SdkInternalApi
public class GetObjectAttributesRequestMarshaller implements Marshaller<GetObjectAttributesRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().requestUri("/{Bucket}/{Key+}?attributes")
    ...
    public SdkHttpFullRequest marshall(GetObjectAttributesRequest getObjectAttributesRequest) {
        Validate.paramNotNull(getObjectAttributesRequest, "getObjectAttributesRequest");
        try {
            ProtocolMarshaller<SdkHttpFullRequest> protocolMarshaller = protocolFactory
                    .createProtocolMarshaller(SDK_OPERATION_BINDING);
            return protocolMarshaller.marshall(getObjectAttributesRequest);
        } catch (Exception e) {
