...
/**
 * {@link CreateMultipartUploadRequest} Marshaller
 */
@Generated("software.amazon.awssdk:codegen")
@SdkInternalApi
public class CreateMultipartUploadRequestMarshaller implements Marshaller<CreateMultipartUploadRequest> {
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().requestUri("/{Bucket}/{Key+}?uploads")
